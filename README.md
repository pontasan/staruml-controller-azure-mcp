...
4. The HTTP server starts — all Azure Architecture Diagram tools become available via MCP
...
```bash
claude mcp add staruml-azure node /absolute/path/to/staruml-controller-azure-mcp/dist/index.js
```
